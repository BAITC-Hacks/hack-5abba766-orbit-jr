import type { Candidate, DateOnly, Id, ParticipationSource } from '../../../../contracts/backend'
...
export function buildBaselineSignals(
  ...
  const relevant = context.history
    ...
    .sort((a, b) => b.date.localeCompare(a.date) || a.record_id.localeCompare(b.record_id))
