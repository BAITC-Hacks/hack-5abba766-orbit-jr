...
export const emptyGuidance: Record<EmptyReason, string> = {
  ...
  NO_BENEFICIAL_EVENTS: "Активности текущего каталога не дают дополнительного прироста по текущим оценкам навыков. Посмотрите оставшиеся разрывы и обсудите с HR другой уровень обучения.",
  NO_GOAL_RELEVANT_EVENTS: "Разрывы с целью ещё есть, но текущий каталог не предлагает шага, который их сократит или откроет полезное обучение. Передайте HR список недостающих навыков ниже, чтобы подобрать другой формат развития.",
};
