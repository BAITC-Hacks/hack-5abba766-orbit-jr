...
export const emptyReasonGuidance: Record<EmptyReason, string> = {
  ...
  NO_BENEFICIAL_EVENTS: "Активности текущего каталога не дают дополнительного прироста по текущим оценкам навыков. Посмотрите оставшиеся разрывы и обсудите с HR другую программу.",
