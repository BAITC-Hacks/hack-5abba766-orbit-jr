...
import type { ParticipationSource } from '../../../contracts/backend'
import { buildBaselineSignals } from '../../src/server/domain/baseline-signals'
import { rankBaseline } from '../../src/server/domain/baseline'
import { candidate, change, input } from '../ai/fixtures'
...
describe('baseline history signals', () => {
  ...
  it('lets observed history change the choice between equally useful activities', () => {
    ...
    const context = { employeeId: 'judge-new', asOfDate: '2026-10-01', unlockedWeightedGain: new Map<string, number>() }
